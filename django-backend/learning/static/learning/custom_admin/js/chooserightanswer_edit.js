...
function addForm() {
    ...
    const isCorrect = newForm.children[2].children[0]
    ...
    const exerciseInput = newForm.children[4]
    const idInput = newForm.children[5]
    ...
    updateInputsPrefix(newCounter0, contentInput, isCorrect, idInput, exerciseInput)
...
function removeForm(e) {
    ...
    for (let i = extraIdx + 1; i < extraFormNodes.length; i++) {
        ...
        const isCorrectInput = extraForm.children[2].children[0]
        const exerciseInput = extraForm.children[4]
        const idInput = extraForm.children[5]

        const counter0 = num - 2
        updateInputsCounter(counter0, contentInput, isCorrectInput, idInput, exerciseInput)
    }
